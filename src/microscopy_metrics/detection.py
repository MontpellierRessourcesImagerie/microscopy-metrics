...
def detect_psf_peak_local_max(image, min_distance=5, threshold_rel=0.3):
...
def detect_psf_blob_log(image, max_sigma = 3, threshold_rel=0.1):
...
def detect_psf_blob_dog(image, max_sigma = 3, threshold_rel=0.1):
